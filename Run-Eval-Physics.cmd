...
C:\training\python311\python.exe C:\training\eval_expertia.py --model C:\training\base\phi-4-mini-reasoning --val C:\training\datasets\expertia-physics-puro_val.jsonl --max-samples 500 --out C:\training\logs\eval_physics_base.json > C:\training\logs\eval_physics_base.log 2>&1
